# KPN Trait Mapping Coverage Report — v0.0.2

## Overall Summary

- **Total traits**: 8402
- **Total mappings**: 24050
- **Traits with any mapping**: 8402 (100.0%)
- **Traits with NO mapping**: 0 (0.0%)
...
|-------------|-------|-----|------|-------|----------|-----|------|
| KPN | 1439 | 1439 (100%) | 944 (66%) | 232 (16%) | 54 (4%) | 1439 (100%) | 0 (0%) |
...
|--------|--------|--------|
| >90% KPN → EFO/MONDO/MESH | 100.0% (1439/1439) | PASS |
